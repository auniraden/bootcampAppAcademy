...
//check if number is 5 or not, if it's not, return false  or not 5
describe("isFive(num)", () => {
...
//check if number is odd, if it is, return true, if it's a even number return false , return error when not a number
...
//check if the range is correct, if it's not, return empty array
