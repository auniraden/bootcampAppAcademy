...
function printHelp() {
  console.log("\nHelp:\n");
  Object.keys(VALID_MOVES).forEach((key) => {
...
function processMove(playerMove, cpuMove) {
  const result = getWinner(playerMove, cpuMove);

  console.log(`You pick ${VALID_MOVES[playerMove].name}, computer picks ${VALID_MOVES[cpuMove].name}.`);
